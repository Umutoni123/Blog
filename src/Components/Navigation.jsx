...
export default function Navigation() {
  return (
    <div>
      <nav
        class=" my-4 pl-6 nav pt-2 pb-2 flex items-center justify-between relative flex-nowrap  gap-x-6 flex-wrap py-1.5
        "
        aria-label="Primary"
      >
        <a
          ...
          data-tracking-control-name="guest_homepage-basic_nav-header-logo"
          data-tracking-will-navigate=""
        >
          <span class="sr-only">LinkedIn</span>
          <icon
            class="block text-color-brand w-[84px] h-[21px] papabear:w-[135px] papabear:h-[34px] order-1 lazy-loaded"
          ...
          >
            <svg
              ...
              version="1.1"
              focusable="false"
              class="lazy-loaded  text-[#0a66c2] text-base opacity scale-x-1 scale-y-1 w-[135px] h-[34px]"
              aria-busy="false"
            >
              <g
                class="inbug"
        ...
        <ul class=" flex  gap-12 items-center nav__menu order-3 after:up-down-divider after:!h-[37px] mr-0.5 babybear:hidden mamabear:hidden">
          <li class="">
            <a
              href="https://www.linkedin.com/pulse/topics/home/?trk=guest_homepage-basic_guest_nav_menu_discover"
              data-tracking-control-name="guest_homepage-basic_guest_nav_menu_discover"
              data-tracking-will-navigate=""
              class="top-nav-link flex justify-center items-center h-[52px] hover:text-color-text visited:hover:text-color-text hover:no-underline
        w-[64px] flex-col mx-1
        text-color-text-low-emphasis visited:text-color-text-low-emphasis"
            >
              <icon
                class="top-nav-link__icon flex h-22 w-22 flex-shrink-0 lazy-loaded"
                aria-hidden="true"
                aria-busy="false"
              >
                <svg
          ...
          <li class="  text-[#000000E6]">
            <a
              href="https://www.linkedin.com/pub/dir/+/+?trk=guest_homepage-basic_guest_nav_menu_people"
              data-tracking-control-name="guest_homepage-basic_guest_nav_menu_people"
              data-tracking-will-navigate=""
              class="top-nav-link flex justify-center items-center h-[52px] hover:text-color-text visited:hover:text-color-text hover:no-underline
        w-[64px] flex-col mx-1
        text-color-text-low-emphasis visited:text-color-text-low-emphasis"
            >
              <icon class="w-22 h-22" aria-hidden="true" aria-busy="false">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="21"
                  height="20"
        ...
        <div class="nav__cta-container order-3 flex gap-8 justify-end min-w-[100px] flex-nowrap flex-shrink-0 babybear:flex-wrap flex-2">
          <a
            class="nav__button-tertiary btn-md btn-tertiary py-[12px] px-[24] align-center"
            href="https://www.linkedin.com/signup/cold-join?trk=guest_homepage-basic_nav-header-join"
            data-tracking-control-name="guest_homepage-basic_nav-header-join"
            data-tracking-will-navigate=""
          >
            Join now
          </a>
          ...
          <a
            class="nav__button-secondary btn-md btn-secondary-emphasis text-[#0a66c2] align-center border rounded-full w-[97.7px] h-[48]  px-[12px] py-[16px] text-base-600"
